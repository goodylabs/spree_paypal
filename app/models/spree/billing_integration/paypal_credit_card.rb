module Spree
  class BillingIntegration::PaypalCreditCard < Spree::BillingIntegration
    ...
    def authorize(money, credit_card, options = {})
      ...
      if payment.response_code.present?
        ...
        response = ActiveMerchant::Billing::Response.new(true, 'Paypal authorization not necessary, because credit card was already authorized')
      end
      response
    end
